# Python service for Wodby

Use Python as a reusable component in applications managed by Wodby. This
repository contains the service manifests and referenced files used by the
public Python service in the Wodby catalog.
...
| Application build | Git source connection enabled; Dockerfile: `Dockerfile`; starters: Python boilerplate |
...
4. Reference `python` from your stack manifest.
